...
Replicate 2: Four pinyon jays (1 female) completed all rounds of the food experiment and 10  jays (1 female) completed all rounds of the social experiment. A further #  jays (5 female) acted as stooge conspecifics in the social experiment. 
...
## Social Experiment
Hypothesis 1 predicted that subjects would choose the larger number of flock mates over the smaller. One sample t-tests provided moderate evidence that our hypothesis was supported for replicate 1 (`r apa_print(social1_results$ttest)$full_result`, `r apa_print(social1_results$ttestbf)$statistic`). However, evidence supported no difference from chance replicate 2 (`r apa_print(social2_results$ttest)$full_result`, `r apa_print(social2_results$ttestbf)$statistic`). <!--This is the only incongruency between the replicates. The slight preference for the larger side is likely not a true preference for larger _amounts_ but rather that a preferred partner is more likely to appear in a larger group. To account for this, we completed 10 replications of each pair instead of 5 in repition 2.-->
