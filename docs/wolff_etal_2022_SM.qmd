...
<!--(foodapp)-->     
(ref:foodapp-cap) Food experiment apparatus (overhead view). Subjects started the trial on the back perch and hopped forward to one of the front perches to signal choice. The experimenter then removed the opposite dish and the subject had up to three minutes to consume their chosen mealworms. Once the subject consumed all mealworms, the next trial started immediately.  Figure used with permission under a CC-BY4.0 license: Wolff et al. (2022); available at https://doi.org/10.31234/osf.io/kxgwt.
...
<!--(socialapp)-->     
(ref:socialapp-cap) Social experiment apparatus (overhead view). Subjects were placed inside the main chamber of the Y maze and shown each bird numerical pair for six seconds a piece (counter balancing side shown first) and then the subject was released. Once the subject crossed under a door, the doors were closed and the bird stayed with their chosen conspecific(s) until 3 minutes had elapsed. They were then taken out of the Y maze and the next subject ran through the experiment. Figure used with permission under a CC-BY4.0 license: Wolff et al. (2022); available at https://doi.org/10.31234/osf.io/kxgwt.
...
<!--(individualpref)-->     
(ref:individualpref-cap) Preference for individual stooge birds per subject bird for replicates 1 and 2. The number of times each stooge bird was chosen when offered as an option per subject bird is shown above in a percentage value out of 100%. The saturation level of the colors indicates strength of preference per subject/stooge pair. High green saturation levels lean towards a preference *against* a particular bird by a subject and a high blue saturation leans *towards* a preference for a particular stooge bird. Asterisks note female pinyon jays. Figure used with permission under a CC-BY4.0 license: Wolff et al. (2022); available at https://doi.org/10.31234/osf.io/kxgwt.
...
individual_preference_table |> 
  ...
  kableExtra::pack_rows(index = c("Experiment 1" = 17, "Experiment 2" = 8)) |> 
